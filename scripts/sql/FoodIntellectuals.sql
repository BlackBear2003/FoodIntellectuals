...
-- (
--     `Id`                   int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
--     `AuthorityName`        varchar(32)  NOT NULL DEFAULT 'default' COMMENT '权限名称',
--     `AuthorityDescription` varchar(256) NOT NULL DEFAULT 'default' COMMENT '权限说明',
--     PRIMARY KEY (`Id`)
...
-- (
--     `RoleId` int(10) unsigned NOT NULL COMMENT '角色ID',
--     `UserId` int(10) unsigned NOT NULL COMMENT '权限ID',
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户角色表';