...
import host.luke.FoodIntellectuals.auth.dto.GetUnionIdDTO;
import host.luke.FoodIntellectuals.auth.vo.RegisterUserVO;
...
public class UserController {
  ...
  public ResponseDto<User> register(@RequestBody RegisterUserVO registerUserVO) {
    ...
    String avatarUrl = ossService.uploadImg(registerUserVO.getAvatarBase64());
